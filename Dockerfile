...
RUN mkdir -p /go/src/github.com/yoeria/gopxe
ADD . /go/src/github.com/yoeria/gopxe
WORKDIR /go/src/github.com/yoeria/gopxe
RUN go test ./...
RUN go build -o main .
...
WORKDIR /gopxe
COPY --from=builder /go/src/github.com/yoeria/gopxe/main /gopxe/
